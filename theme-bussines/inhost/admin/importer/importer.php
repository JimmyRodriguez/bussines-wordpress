...
function inwave_import_sliders(){
    ...
    if (class_exists('RevSlider')) {
        ...
        // import slider 1
        $_FILES["import_file"]["tmp_name"] = get_template_directory() . '/admin/importer/data/slider1.zip';
        ob_start();
        $revapi->importSliderFromPost();
        ob_end_clean();

        // import slider 2
        $_FILES["import_file"]["tmp_name"] = get_template_directory() . '/admin/importer/data/slider2.zip';
        ob_start();
        $revapi->importSliderFromPost();
        ob_end_clean();

        // import slider 3
        $_FILES["import_file"]["tmp_name"] = get_template_directory() . '/admin/importer/data/slider3.zip';
        ob_start();
        $revapi->importSliderFromPost();
        ob_end_clean();
    }
